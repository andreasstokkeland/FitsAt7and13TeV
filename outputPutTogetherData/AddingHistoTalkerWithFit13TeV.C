...
//
    ...
    TH1D* hCk1 = new TH1D( "Theconstantk" , "The n2-values over their particles' mass at #sqrt{s} = 13 TeV", 3, 0, 3)    ;
    TH1D* hCk2 = new TH1D( "Theconstantk" , "The n2-values over their particles' mass at #sqrt{s} = 13 TeV", 3, 0, 3)    ;
    TH1D* hCk3 = new TH1D( "Theconstantk" , "The n2-values over their particles' mass at #sqrt{s} = 13 TeV", 3, 0, 3)    ;
...
//    hCk ->GetYaxis()->SetTitle("n2-value/mass (1/GeV)");
    ...
    for (int i = 0 ; i < 3; i++){
        ...
        HistosCH[i]->SetTitle( "n1-values for each multiplicity class at #sqrt{s} = 13 TeV" );
    ...
    TCanvas *cCS = new TCanvas("cN12", "(n2-n1)-values for each multiplicity class");
    cout << "Hej" << endl;
    ...
    for (int i = 0 ; i < 3; i++){
        ...
        HistosCS[i]->SetTitle( "(n2-n1)-values for each multiplicity class at #sqrt{s} = 13 TeV" );
