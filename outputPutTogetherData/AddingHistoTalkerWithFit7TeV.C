...
void AddingHistoTalker() {
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosPion[i] = (TH1D*)file->Get(Form("%d.root", YPion[i]  ));
        
    }
    
    
    TFile* fileP = TFile::Open( "Tot11.root.root" );
    
    if(!fileP)
    return;
    
    HistosPion[9] = (TH1D*)fileP->Get( "Tot11.root.root"  );
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosMBPion[i] = (TH1D*)file->Get(Form("Div%d.root.root", YPion[i]  ));
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosKaon[i] = (TH1D*)file->Get(Form("%d.root", YKaon[i]  ));
        
    }
    
    TFile* fileK = TFile::Open( "Tot21.root.root" );
    
    if(!fileK)
    return;
    
    HistosKaon[9] = (TH1D*)fileK->Get( "Tot21.root.root"  );
    ...
    for (int i = 0; i <= 9 ; i++){
        ...
        funcsKaon[i] = fm->GetLevi(massKaon, 0.19, 750,3);
        funcsKaon[i]->SetRange(0.4, 10);
        HistosKaon[i]->Fit(funcsKaon[i],"","",0.4,10);
        
        cout << funcsKaon[i]->GetParameter(1) << endl;
    
    }
    
    funcsKaon[8] = fm->GetLevi(massKaon, 0.4, 750,3);
    funcsKaon[8]->SetRange(0.4, 10);
    HistosKaon[8]->Fit(funcsKaon[8],"","",0.4,10);
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosMBKaon[i] = (TH1D*)file->Get(Form("Div%d.root.root", YKaon[i]  ));
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosProton[i] = (TH1D*)file->Get(Form("%d.root", YProton[i]  ));
        
    }
    
    TFile* filePr = TFile::Open( "Tot31.root.root" );
    
    if(!filePr)
    return;
    
    HistosProton[9] = (TH1D*)filePr->Get( "Tot31.root.root"  );
    ...
    for (int i = 0; i <9; i++){
        ...
        HistosMBProton[i] = (TH1D*)file->Get(Form("Div%d.root.root", YProton[i]  ));
    ...
    //cPion->SaveAs( "HEPDataPionFit7TeV.eps" );
    ...
    //cKaon->SaveAs( "HEPDataKaonFit7TeV.eps" );
    ...
    //cProton->SaveAs( "HEPDataProtonFit7TeV.eps" );
    ...
    for (int i = 0; i < 9 ; i++){
        ...
        HistosMBPion[i]->SetTitle( "Levi fits for each multiplicity divided by Levi fit for min bias at #sqrt{s} = 7 TeV for #pi#pm" );
    ...
    cDivPion->SaveAs( "HEPDataPionFitDiv7TeV.eps" );
    ...
    cN1Pion->SaveAs( "HEPDataPionN17TeV.eps" );
    ...
    cN12Pion->SaveAs( "HEPDataPionN127TeV.eps" );
    ...
    for (int i = 0; i < 9 ; i++){
        ...
        HistosMBKaon[i]->SetTitle( "Levi fits for each multiplicity divided by Levi fit for min bias at #sqrt{s} = 7 TeV for K#pm" );
    ...
    cDivKaon->SaveAs( "HEPDataKaonFitDiv7TeV.eps" );
    ...
    cN1Kaon->SaveAs( "HEPDataKaonN17TeV.eps" );
    ...
    cN12Kaon->SaveAs( "HEPDataKaonN127TeV.eps" );
    ...
    for (int i = 0; i < 9 ; i++){
        ...
        HistosMBProton[i]->SetTitle( "Levi fits for each multiplicity divided by Levi fit for min bias at #sqrt{s} = 7 TeV for protons" );
    ...
    cDivProton->SaveAs( "HEPDataProtonFitDiv7TeV.eps" );
    ...
    TH1D* hN1Proton = new TH1D( "Div" , "n1-values for each multiplicity at #sqrt{s} = 7 TeV", 9, -0.5, 8.5)    ;
    ...
    cN1Proton->SaveAs( "HEPDataProtonN17TeV.eps" );
    ...
    TH1D* hN12Proton = new TH1D( "Div" , "The (n2-n1)-values for each multiplicity #sqrt{s} = 7 TeV", 9, -0.5, 8.5)    ;
    ...
    cN12Proton->SaveAs( "HEPDataProtonN127TeV.eps" );
...
void AddingHistos(){
    ...
    TCanvas *cCS = new TCanvas("cN12", "(n2-n1)-values for each multiplicity at #sqrt{s} = 7 TeV");
    cout << "Hej" << endl;
